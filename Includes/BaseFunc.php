...
2019-09-20:
Some small amount of code cleanup by Hatsen
...
rewrite of substr (because substr() used an extreme amount of ram, I decided to make a little rewrite so that I'm in control with what is happening)
...
{	//By  Cytox  2009-05-14
	//NOTE: this function will automaticly change '�, �, �,  , �, �, �'  -->  'ae, oe, aa, _, AE, OE, AA'  without an option to change this behaviour
